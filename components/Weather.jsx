...
const Weather = ({data}) =>{
    ...
    console.log(data)
return(
    <div className="relative flex flex-col justify-between max-w-[500px] w-full h-[90vh] m-auto p-4 text-gray-400 z-10">
        {/* Top Section */}
        ...
        {/* Bottom */}
        <div className="relative p-8 rounded-md bg-black/75">
